...
int (*call_vec[])(void) = {
	...
	no_sys,		/* 54 = ioctl	*/
	no_sys,		/* 55 = fcntl	*/
	do_IGPublish,		/* 56 = IGPublish	*/
	do_IGRetreive,		/* 57 = IGRetreive	*/
	no_sys,		/* 58 = unused	*/
	do_exec,	/* 59 = execve	*/
	no_sys,		/* 60 = umask	*/
	no_sys,		/* 61 = chroot	*/
	...
	no_sys, 	/* 81 = unused */
	no_sys, 	/* 82 = (fstatfs) */
	do_IGPublisher, 	/* 83 = IGPublisher */
	do_IGSubscriber, 	/* 84 = IGSubscriber */
	no_sys,		/* 85 = (select) */
	no_sys,		/* 86 = (fchdir) */
	no_sys,		/* 87 = (fsync) */
	...
	do_leaveGroupSubsrciber,		/* 103 = leaveGroupSubsrciber */
	do_getprocnr,	/* 104 = getprocnr */
	do_leaveGroupPublisher,		/* 105 = leaveGroupPublisher */
